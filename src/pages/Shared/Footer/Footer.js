      ...
      <div className="row d-flex justify-content-center align-items-center pb-3">
        ...
        <div className="col-12 col-lg-4 col-md-6">
          ...
          <div className="d-flex justify-content-center align-items-center">
            <p className="fb-icon">
              <i className="fa-brands fa-2x fa-facebook-square"></i>
            </p>
            <p className="ms-5 me-5 ins-icon">
              <i className="fa-brands fa-2x fa-instagram-square"></i>
            </p>
            <p className="tw-icon">
              <i className="fa-brands fa-2x fa-twitter-square"></i>
            </p>
          </div>
        </div>
        <div className="col-12 col-lg-4 d-flex justify-content-center">
          <a className="m-2 text-decoration-none" href="#">
            Our Policies
          </a>
          <a className="m-2 text-decoration-none" href="#">
            Contact Us
